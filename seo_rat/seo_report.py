...
# %% auto #0
__all__ = ['sync_articles_to_db', 'find_duplicate_metadata', 'analyze_links', 'analyze_article', 'generate_seo_report']
...
from .seo_content_analysis import check_h1_count
...
def analyze_article(article: Article, domain: str, is_quarto: bool) -> dict:
    ...
    return {
        ...
        "title_check": check_title_length(metadata.get("title", "")),
        "description_check": check_desc_length(metadata.get("description", "")),
        "content_check": check_content_length(content),
        "h1_check": check_h1_count(
            headers, title=metadata.get("title", ""), is_quarto=is_quarto
        ),
...
def generate_seo_report(
    session: Session, website_id: int, domain: str, is_quarto: bool
) -> dict:
