...
# %% auto #0
__all__ = ['INTENT_PATTERNS', 'STOP_WORDS', 'urls', 'url_mapping', 'apply_strftime', 'get_date_ranges_for_comparison',
           'compare_periods', 'detect_query_trends', 'classify_intent', 'classify_page_intents',
           'query_words_in_content', 'find_missing_queries', 'find_green_keywords']
...
# %% ../nbs/12_gsc_insights.ipynb #38054a24
