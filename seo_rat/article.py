...
def insert_article(session: Session, website_id: int, file_path: str, focus_keyword: str = None) -> Article:
    """Insert new article"""
    article = Article(
...
#| export
def update_article_keyword(session: Session, article_id: int, focus_keyword: str) -> Optional[Article]:
